...
public class Cyclic_Merging {
    ...
    public static void solve(FastScanner fs, int n, long[] nums) throws IOException {
        long sum = 0;
        long maxNum = 0;
        ...
        for(int i = 0; i < n; i++) {
            ...
            long currNum = Math.max(num, next);
            sum += currNum;
        }

        fs.writer().write((sum - maxNum) + " \n");
    }
