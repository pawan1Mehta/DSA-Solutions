...
public class First_element_at_least_X2 {
    ...
    public static class SegmentTree {
        ...
        private int findMinIndex(int v, int tl, int tr, int l, int x) {
            if(tree[v] < x || tr < l) {
                return -1;
            }
            ...
            int index = findMinIndex(2 * v, tl, tmid, l, x);

            if(index == -1) {
                return findMinIndex(2 * v + 1, tmid + 1, tr, l, x);
            }
        ...
        public long findMinIndex(int l, int x) {
            return findMinIndex(1, 0, n - 1, l, x);
        }
    }
        ...
        while(k-- > 0) {
            ...
            for(int i = 0; i < m; i++) {
                ...
                if(a == 1) {
                    ...
                    fs.writer().write(st.findMinIndex(c, b)+ "\n");
                }
            }
        }
