...
public class CreatingStrings {
    ...
    private static void stringPermutation(StringBuilder str, int i, Set<String> res) {
        if(i == str.length()) {
    ...
    private static Set<String> solve(String str) {
        Set<String> res = new TreeSet<>();

        stringPermutation(new StringBuilder(str), 0, res);
