            ...
            if(mat[0][0] == 0 && mat[n - 1][n - 1] == 0) {
                ...
                for(int i = 1; i < n; i++) {
                    for(int j = 1; j < n; j++) {
                        ...
                        int options = 0;
                        if(mat[i][j - 1] != Integer.MAX_VALUE) {
                            options = (options + mat[i][j - 1]) % MOD;
                        }
                        if(mat[i - 1][j] != Integer.MAX_VALUE) {
                            options = (options + mat[i - 1][j]) % MOD;
                        }
                ...
                res = mat[n - 1][n - 1] == Integer.MAX_VALUE ? 0 : mat[n - 1][n - 1];
            }
